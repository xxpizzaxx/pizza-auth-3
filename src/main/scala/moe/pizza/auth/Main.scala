        ...
        c.servers match {
          case Some(s) =>
            ...
            if (s.webinterface) {
              ...
              val webapp = new Webapp(configfile.get, graders, 9021, new LdapUserDatabase(lc, ldap.directoryService.getSchemaManager, configfile.get.embeddedldap.basedn), None, None, None, None, broadcasters)
